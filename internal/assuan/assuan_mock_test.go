...
//
//	go tool mockgen -source=assuan.go -destination=assuan_mock_test.go -package=assuan_test -write_generate_directive -prog_name=go tool mockgen
//
...
//go:generate go tool mockgen -source=assuan.go -destination=assuan_mock_test.go -package=assuan_test -write_generate_directive "-prog_name=go tool mockgen"
