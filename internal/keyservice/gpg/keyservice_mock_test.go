...
//
//	go tool mockgen -source=keyservice.go -destination=keyservice_mock_test.go -package=gpg_test -write_generate_directive -prog_name=go tool mockgen
//

// Package gpg_test is a generated GoMock package.
package gpg_test
...
//go:generate go tool mockgen -source=keyservice.go -destination=keyservice_mock_test.go -package=gpg_test -write_generate_directive "-prog_name=go tool mockgen"
